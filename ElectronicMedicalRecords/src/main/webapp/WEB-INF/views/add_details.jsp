		...
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				...
				<ul class="nav nav-pills">
					<li class="active"><a
						href="${contextPath}/physician/add_details">Patient-details</a></li>
					<li><a href="${contextPath}/physician/add_apptdetails">Add
							Appointment details</a></li>

					<li><a href="${contextPath}/physician/add_vitals">Add
							Vitals</a></li>
				</ul>
				<br>
				<br>
					...
					<div class="tab-pane active" id="tab1">
						<div class="container center_div">
							<form>
								...
								<br>
								<div class="row">
									<label class="control-label col-sm-2" for="prog">Name
										of the patient</label>
									<div class="col-xs-2">
								...
								<div class="row">
									...
									<div class="col-xs-2">
										<input type="text" class="form-control" name="location"
											value="${patient.location}" readonly>
									</div>
								</div>
								<br>
								<div class="row">
									...
									<div class="col-xs-2">
										<input type="text" class="form-control" name="contact"
											value="${patient.contact}" readonly>
									</div>
								</div>
								<br>
								<div class="row">
									<label class="control-label col-sm-2" for="prog">UserName</label>
									<div class="col-xs-2">
										<input type="text" class="form-control" name="username"
											value="${patient.username}" readonly>
									</div>
								</div>
