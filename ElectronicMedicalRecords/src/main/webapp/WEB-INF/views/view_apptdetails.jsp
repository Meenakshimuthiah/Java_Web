		...
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				<ul class="nav nav-pills">
					<li><a href="${contextPath}/patient/search_appointment">Home</a></li>
					<li class="active"><a
						href="${contextPath}/patient/view_apptdetails">Add Appointment
							details</a></li>

					<li><a href="${contextPath}/patient/view_vitals">Add
							Vitals</a></li>
				</ul>
					...
					<div class="tab-pane active" id="tab1">
						<div class="container center_div">
							<form>
								...
								<div class="row">
									...
									<div class="col-xs-2">
										<input type="text" class="form-control" name="reason"
											value="${a.reasonForVisit}">
									</div>
								</div>
								<br>
								<div class="row">
									<label class="control-label col-sm-2" for="prog">Date
								...
								<br>
								<div class="row">
									<label class="control-label col-sm-2" for="prog">Appointment
										Description</label>
									<div class="col-xs-2">
										<input type="text" class="form-control" name="desc"
											value="${a.appointmentDesc}">
									</div>
								</div>
