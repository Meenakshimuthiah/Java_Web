		...
		<div class="row content">
			...
			<div class="col-sm-8 text-left">
				...
				<ul class="nav nav-pills">
					...
					<li><a href="${contextPath}/physician/add_physician">Add
							Physician</a></li>

					<li><a href="${contextPath}/patient/add_patient">Add
							Patient</a></li>
				</ul>
							...
							<div class="panel-group" id="accordion">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion"
												href="#collapse1">List of Physicians</a>
										</h4>
									</div>
									<div id="collapse1" class="panel-collapse collapse in">
										<div class="panel-body">
											<form action="${contextPath}/admin/delete_physician"
												method="post">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion"
												href="#collapse2">List of Patients</a>
										</h4>
									</div>
									<div id="collapse2" class="panel-collapse collapse">
										<div class="panel-body">
											<form action="${contextPath}/admin/delete_patient"
												method="post">
												<table class="table table-hover">
													<tr>
														<td></td>
													...
													<c:forEach items="${plist}" var="dList">
														<tr>
															<td><input type="radio" name="patient"
																value="${dList.UId}" /></td>
															<td>${dList.UId}</td>
															<td>${dList.username}</td>
															<td>${dList.name}</td>
