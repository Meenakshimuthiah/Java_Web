  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
		...
		<ul class="nav nav-pills">
			...
			<li><a href="${contextPath}/patient/add_patient">Add Patient</a></li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="tab1">
				<div class="container center_div">
					<form:form action="${contextPath}/physician/add_physician"
						modelAttribute="physician" method="post">
						...
						<table>
							...
							<tr>
								<td>Practice Type</td>
								<td><form:input path="practiceType" size="30"
										required="required" /> <font color="red"><form:errors
											path="practiceType" /></font></td>
							</tr>
							<tr>
								<td>User name:</td>
							...
							<tr>
								<td>Role:</td>
								<td><form:input path="role" size="30" value="physician"
										readonly="true" /> <form:errors path="role" /></td>
							</tr>

							<tr>
								<td colspan="2"><input type="submit" value="Add Physician" /></td>
							</tr>
						</table>
